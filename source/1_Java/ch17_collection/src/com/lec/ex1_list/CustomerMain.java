...
public class CustomerMain {
	public static void main(String[] args) {
		...
		ArrayList<Customer> customers = new ArrayList<Customer>(); // Customer[]cs = new Customer[10]; //!중요
...
//				customers.add(temp);
		...
		} while (true); // 반드시 한번은 물어보니까 do while문 사용 //n이 아니다 다른거 쓰나 이 문은 계속 돈다 // while
