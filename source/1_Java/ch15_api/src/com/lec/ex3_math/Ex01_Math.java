...
public class Ex01_Math {
	public static void main(String[] args) {
		...
		System.out.println("1,2의 최고값은" + Math.min(1, 2));
		System.out.println("1,2의 최고값은" + Math.max(1, 2));
		// Math의 변수(static final 변수)
		System.out.println("pi값은" + Math.PI);
		System.out.println("sin(PI) : " + Math.asin(Math.PI));
		System.out.println("cos(PI) : " + Math.asin(Math.PI));
	}
}
